...
class KeyInit():
    def __init__(self, packet):
        self.packet = packet
        self.packet.client.command_stack.append(lambda data: \
            self.key_packet_initialization(data))
    ...
    def key_packet_initialization(self, to_c_data: bytes) -> bytes:
        ...
        if to_c_data:
            for stack, obj in zip([self.packet.client.command_stack,
                ...
                stack.append(lambda data, obj=obj: obj.pck_len.pck_in(data))
                ...
                stack.append(lambda gen, manager=self.packet.manager,
                    ...
                    self.packet.manager.set_manager_data(name, gen, peername))
                stack.append(lambda gen, obj=obj: obj.pck_len.pck_out(gen))
            self.packet.client.command_stack.append(lambda data: \
                          key_packet_initialization_remover(data))
        return to_c_data
