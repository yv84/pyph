...
class c_Action():
  ...
  def dtype(self, act, data):
    dtype = [('pck_type', 'i1')
              ...
              , ('OriginY', 'i4')
              , ('OriginZ', 'i4')
              , ('ActionID0Simpleclick1Shiftclick', 'i1')
                  ]
    return dtype
#--------------------------------------------------------------------------#22
...
class c_RequestKeyMapping():
  ...
  def dtype(self, act, data):
    ...
    return dtype
#--------------------------------------------------------------------------#D023
class c_RequestExRemoveItemAttribute():
  def __init__(self):
...
class c_RequestExEnchantSkillRouteChange():
  ...
  def dtype(self, act, data):
    ...
    return dtype
#--------------------------------------------------------------------------#D035
class c_RequestExEnchantItemAttribute():
  def __init__(self):
  ...
  def dtype(self, act, data):
    ...
    return dtype
#--------------------------------------------------------------------------#D036
class c_RequestExShowCharacterList():
  def __init__(self):
...
class c_RequestDispel():
  ...
  def dtype(self, act, data):
    ...
    return dtype
#--------------------------------------------------------------------------#D04C
class c_RequestExTryToPutEnchantTargetItem():
  def __init__(self):
  ...
  def dtype(self, act, data):
    ...
    return dtype
#--------------------------------------------------------------------------#D04D
class c_RequestExTryToPutEnchantSupportItem():
  def __init__(self):
...
class c_RequestExCancelEnchantItem():
  ...
  def dtype(self, act, data):
    ...
    return dtype
#--------------------------------------------------------------------------#D04F
class c_RequestChangeNicknameColor():
  def __init__(self):
...
class c_RequestJump():
  ...
  def dtype(self, act, data):
    ...
    return dtype
#--------------------------------------------------------------------------#D056
class c_NotifyStartMiniGame():
  def __init__(self):
    self.lst, self.pck, self.invoke= [], b'', b'\xD0\x56\x00'
  def dtype(self, act, data):
    dtype = [('pck_type', 'i1')
              , ('subID', 'i2')
                  ]
  ...
  def f_ListSize(self):
    for i in range(self.It.__next__()):
      dtype = ('ListSize_' + str(i) , [
              ...
              , ('0_1', 'i2')
              , ('customtype2', 'i2')
              , ('AttackAttrElement', 'i2')
              , ('AttackAttrElementVal', 'i2')
              , ('DefAttrFire', 'i2')
              , ('DefAttrWater', 'i2')
              , ('DefAttrWind', 'i2')
              , ('DefAttrEarth', 'i2')
...
class s_KeyPacket():
  ...
  def dtype(self, act, data):
    dtype = [('pck_type', 'i1')
              , ('id0wrongprotocol1protocolok', 'i1')
              , ('key', 'i8')
              , ('01_0', 'i4')
              , ('ServerID', 'i4')
              , ('01_1', 'i1')
...
class s_WareHouseDepositList():
  ...
  def dtype(self, act, data):
    if   act == 1:
      ...
      self.lst= data
    dtype = [('pck_type', 'i1')
              , ('WhType01private02clan03castle04freight', 'i2')
              , ('PlayerAdena', 'i8')
              , ('ListSizeValue', 'i2')
                  ]+ list(self.f_ListSize()) +[
                  ]
...
class s_MagicSkillLaunched():
  ...
  def dtype(self, act, data):
    ...
    dtype = [('pck_type', 'i1')
              ...
              , ('SkillID', 'i4')
              , ('SkillLevel', 'i4')
              , ('numberOfTargetsValue', 'i4')
                  ]+ list(self.f_numberOfTargets()) +[
                  ]
    return dtype
  def f_numberOfTargets(self):
    for i in range(self.It.__next__()):
      dtype = ('numberOfTargets_' + str(i) , [
               ('TargetID', 'i4')
                  ])
      yield dtype 
  def parse_packet(self):
...
class s_SystemMessage():
  ...
  def dtype(self, act, data):
    ...
    dtype = [('pck_type', 'i1')
              , ('MsgID', 'i4')
              , ('typesCountValue', 'i4')
                  ]+ list(self.f_typesCount()) +[
                  ]
    return dtype
  def f_typesCount(self):
    for i in range(self.It.__next__()):
      dtype = ('typesCount_' + str(i) , [
               ('0Str1Int2NpcID3ItmID4SklID6Amnt', 'i4')
...
class s_SSQInfo():
  ...
  def dtype(self, act, data):
    dtype = [('pck_type', 'i1')
              , ('State258DawnSky257DuskSky256normal', 'i2')
                  ]
    return dtype
#--------------------------------------------------------------------------#74
...
class s_PetInfo():
  ...
  def dtype(self, act, data):
    if   act == 1:
      ...
      self.lst= data
    dtype = [('pck_type', 'i1')
              , ('SummonType1Summon2Pet', 'i4')
              , ('ObjectID', 'i4')
              , ('SummonNpcID1000000', 'i4')
              , ('attackable0', 'i4')
              , ('X', 'i4')
              , ('Y', 'i4')
              , ('Z', 'i4')
              ...
              , ('isInCombat', 'i1')
              , ('isAlikeDead', 'i1')
              , ('isSummoned0teleported1default2summoned', 'i1')
              ...
              , ('AtkSpd_1', 'i4')
              , ('CastSpd_1', 'i4')
              , ('AbnormalEffectbleed1poison2poisonbleed3flame4', 'i4')
              , ('isMountable', 'i2')
              , ('0_1', 'i1')
              , ('0_2', 'i2')
              , ('TeamAura1blue2red', 'i1')
              , ('SoulShotsPerHit', 'i4')
...
class s_MultiSellList():
  ...
  def dtype(self, act, data):
    ...
    dtype = [('pck_type', 'i1')
              ...
              , ('Size28', 'i4')
              , ('EntryCountValue', 'i4')
                  ]+ list(self.f_EntryCount()) +[
                  ]
    return dtype
  def f_EntryCount(self):
    for i in range(self.It.__next__()):
      dtype = ('EntryCount_' + str(i) , [
               ('EntryID', 'i4')
              , ('01', 'i1')
              , ('0_0', 'i2')
              , ('0_1', 'i4')
...
class s_ConfirmDlg():
  ...
  def f_ListSize(self):
    for i in range(self.It.__next__()):
      dtype = ('ListSize_' + str(i) , [
               ('Typetext0number1npcname2itemname3skillname4zonename7', 'i4')
              , ('Name', '|S'+str(self.It.__next__()) )
                  ])
      yield dtype 
  def parse_packet(self):
...
class s_ExFishingStart():
  ...
  def dtype(self, act, data):
    dtype = [('pck_type', 'i1')
              ...
              , ('0_0', 'i1')
              , ('0_1', 'i1')
              , ('isNightLure1DayLure2NightLure', 'i1')
              , ('0_2', 'i1')
                  ]
    return dtype
#--------------------------------------------------------------------------#FE1F
...
class s_ExReplyDominionInfo():
  ...
  def dtype(self, act, data):
    ...
    dtype = [('pck_type', 'i1')
              , ('subID', 'i2')
              , ('castlesCountValue', 'i4')
                  ]+ list(self.f_castlesCount()) +[
                  ]
    return dtype
  def f_castlesCount(self):
    for i in range(self.It.__next__()):
      dtype = ('castlesCount_' + str(i) , [
               ('CastleId50', 'i4')
              , ('CastleName', '|S'+str(self.It.__next__()) )
              , ('OwnerName', '|S'+str(self.It.__next__()) )
              , ('wards1', 'i4')
...
class s_ExBrExtraUserInfo():
  ...
  def dtype(self, act, data):
    ...
    return dtype
#--------------------------------------------------------------------------#FEB8
class s_ExBR_GamePoint():
  def __init__(self):
    self.lst, self.pck, self.invoke= [], b'', b'\xFE\xB8\x00'
  def dtype(self, act, data):
    dtype = [('pck_type', 'i1')
                  ]
    return dtype
#--------------------------------------------------------------------------#FEB9
class s_ExBR_ProductList():
  def __init__(self):
    self.lst, self.pck, self.invoke= [], b'', b'\xFE\xB9\x00'
  def dtype(self, act, data):
    dtype = [('pck_type', 'i1')
                  ]
    return dtype
#--------------------------------------------------------------------------#FEBA
class s_ExBR_ProductInfo():
  def __init__(self):
    self.lst, self.pck, self.invoke= [], b'', b'\xFE\xBA\x00'
  def dtype(self, act, data):
    dtype = [('pck_type', 'i1')
                  ]
    return dtype
#--------------------------------------------------------------------------#FEBB
class s_ExBR_BuyProduct():
  def __init__(self):
...
class s_ExBrBuffEventState():
  ...
  def dtype(self, act, data):
    ...
    return dtype
#--------------------------------------------------------------------------#FEC0
class s_ExBR_RecentProductList():
  def __init__(self):
  ...
  def dtype(self, act, data):
    ...
    return dtype
#--------------------------------------------------------------------------#FEC1
class s_ExBR_LoadEventTopRankers():
  def __init__(self):
    self.lst, self.pck, self.invoke= [], b'', b'\xFE\xC1\x00'
  def dtype(self, act, data):
    dtype = [('pck_type', 'i1')
                  ]
    return dtype
#--------------------------------------------------------------------------#FEC2
class s_ExBR_MinigameLoadScore():
  def __init__(self):
    self.lst, self.pck, self.invoke= [], b'', b'\xFE\xC2\x00'
  def dtype(self, act, data):
    dtype = [('pck_type', 'i1')
                  ]
    return dtype
class Pck_invoke_dict():
 ...
 def get_Pck_invoke_c(self):
   ...
   self.Pck_invoke_s[c_RequestExRemoveItemAttribute().invoke] = c_RequestExRemoveItemAttribute()
   ...
   self.Pck_invoke_s[c_RequestExEnchantItemAttribute().invoke] = c_RequestExEnchantItemAttribute()
   self.Pck_invoke_s[c_RequestExShowCharacterList().invoke] = c_RequestExShowCharacterList()
   ...
   self.Pck_invoke_s[c_RequestExTryToPutEnchantTargetItem().invoke] = c_RequestExTryToPutEnchantTargetItem()
   self.Pck_invoke_s[c_RequestExTryToPutEnchantSupportItem().invoke] = c_RequestExTryToPutEnchantSupportItem()
   self.Pck_invoke_s[c_RequestExCancelEnchantItem().invoke] = c_RequestExCancelEnchantItem()
   self.Pck_invoke_s[c_RequestChangeNicknameColor().invoke] = c_RequestChangeNicknameColor()
   self.Pck_invoke_s[c_RequestResetNickname().invoke] = c_RequestResetNickname()
   self.Pck_invoke_s[c_RequestJump().invoke] = c_RequestJump()
   self.Pck_invoke_s[c_NotifyStartMiniGame().invoke] = c_NotifyStartMiniGame()
   self.Pck_invoke_s[c_RequestDominionInfo().invoke] = c_RequestDominionInfo()
   self.Pck_invoke_s[c_RequestSeedPhase().invoke] = c_RequestSeedPhase()
   self.Pck_invoke_s[c_BR_GamePoint().invoke] = c_BR_GamePoint()
   self.Pck_invoke_s[c_BR_ProductList().invoke] = c_BR_ProductList()
 ...
 def get_Pck_invoke_s(self):
   ...
   self.Pck_invoke_c[s_MultiSellList().invoke] = s_MultiSellList()
   ...
   self.Pck_invoke_c[s_ExAirShipStopMove().invoke] = s_ExAirShipStopMove()
   ...
   self.Pck_invoke_c[s_ExBR_GamePoint().invoke] = s_ExBR_GamePoint()
   self.Pck_invoke_c[s_ExBR_ProductList().invoke] = s_ExBR_ProductList()
   self.Pck_invoke_c[s_ExBR_ProductInfo().invoke] = s_ExBR_ProductInfo()
   self.Pck_invoke_c[s_ExBR_BuyProduct().invoke] = s_ExBR_BuyProduct()
   self.Pck_invoke_c[s_ExBR_PremiumState().invoke] = s_ExBR_PremiumState()
   ...
   self.Pck_invoke_c[s_ExBR_RecentProductList().invoke] = s_ExBR_RecentProductList()
   self.Pck_invoke_c[s_ExBR_LoadEventTopRankers().invoke] = s_ExBR_LoadEventTopRankers()
   self.Pck_invoke_c[s_ExBR_MinigameLoadScore().invoke] = s_ExBR_MinigameLoadScore()
